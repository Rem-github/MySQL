...
-- список пользователей которые сделали хотя бы 1 покупку
SELECT DISTINCT name FROM users JOIN orders ON orders.user_id = users.id;

-- список товаров и соответствующих каталогов
SELECT products.name AS 'Товар', catalogs.name AS 'Каталог' 
